# -*- coding: utf-8 -*-
"""
Created on Thu Jun 21 00:45:20 2018
...
data_WC_2018 = pd.read_csv("data/data_full_feature/abnormaly/data_WC_2018_round1.csv", encoding='utf-8')
...
data_WC_2018['match_type'] = encoder.transform(data_WC_2018['match_type'])
test_size = 0.3
...
data_x_18 = data_WC_2018.loc[:,'match_type':]
...
feature_importance.to_csv("temp/feature_importance_abnormaly_round1.csv")
...
result_report['Round'] = data_WC_2018['id']
...
result_report['odd_diff_win'] = data_WC_2018['odd_diff_win']
result_report['odd_draw'] = data_WC_2018['odd_draw']


result_report.to_csv("temp/abnormal_round1.csv",index=False)
